...
export class WebviewProvider {
        ...
        panel.webview.onDidReceiveMessage((message: WebviewMessage) => {
            ...
            switch (message.command) {
                ...
                case "saveSVG": {
                    ...
                    const customStyles = workspace.getConfiguration("lpg").customCSS as string | string[];
                    ...
                    try {
                        Utils.exportDataWithConfirmation(path.join(
                            workspace.getConfiguration("lpg." + message.type).saveDir || "",
    ...
    protected getStyles(webView: Webview): string {
        ...
        const paths = workspace.getConfiguration("lpg").customCSS as string | string[];
